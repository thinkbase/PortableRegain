...
java %JAVA_OPTS% -Dfile.encoding=UTF-8 -cp !IK_EXT_HOME!/bin;!IK_HOME!/IKAnalyzer2012_u6.jar;!REGAIN_HOME!/runtime/crawler/regain-crawler.jar net.sf.regain.crawler.Main -config "!CRAWLER_WORKSPACE!/CrawlerConfiguration.xml" -logConfig "!CRAWLER_WORKSPACE!/log4j.properties"
